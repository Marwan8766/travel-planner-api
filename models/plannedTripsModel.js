...
const plannedTripSchema = new mongoose.Schema({
  ...
  preferences: {
    ...
    likes_outdoorActivities: { type: Boolean, default: false },
    likes_shopping: { type: Boolean, default: false },
    likes_food: { type: Boolean, default: false },
    likes_sports: { type: Boolean, default: false },
    likes_relaxation: { type: Boolean, default: false },
    likes_familyFriendlyActivities: { type: Boolean, default: false },
  },
  crowdLevel: {
    type: String,
